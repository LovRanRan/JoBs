      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            维护一份 Master Resume,每个岗位自动派生定制版本
          </p>
        </div>
        ...
        {resumes.map((r) => (
          ...
          >
            <div>
              ...
              {r.tailoredFor && (
                <div className="text-xs text-gray-500 mt-0.5">定制自:{r.tailoredFor}</div>
              )}
            ...
            <div className="text-right">
              <div className="text-xs text-gray-400">更新 {r.updatedAt}</div>
